<!-- Modal -->
@php
 $captcha_data = \App\Helpers\Helper::captchaSet('workshop_brochure');
@endphp

<form action="{{ route('workshop-brochure') }}" method="POST"  class="form">@csrf
    <div class="modal fade" id="workshopBrochureModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="workshopBrochureModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="workshopBrochureModalLabel"> Bakery & Cafe Mastery Workshop Brochure</h5>
