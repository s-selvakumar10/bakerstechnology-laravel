...
use App\Models\AttendeesHyderabad;
...
class AttendeesHyderabadController extends Controller
{
   
    public function downloadPDF($id){
        $data = AttendeesHyderabad::findOrFail($id);
        ...
        $pdf_data['pdf_template_img'] = public_path('/assets/img/pdf/hyd.jpg');
